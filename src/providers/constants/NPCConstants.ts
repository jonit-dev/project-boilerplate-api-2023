...
export const NPC_SKILL_LEVEL_MULTIPLIER = 2;
export const NPC_SKILL_STRENGTH_MULTIPLIER = 2;
export const NPC_SKILL_DEXTERITY_MULTIPLIER = 2;
export const NPC_SKILL_RESISTANCE_MULTIPLIER = 2;
