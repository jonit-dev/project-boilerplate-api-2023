...
export const CraftingSkillsMap = new Map<string, string>([
  ...
  [CraftingResourcesBlueprint.GreenIngot, CraftingSkill.Blacksmithing],
  [CraftingResourcesBlueprint.ObsidiumIngot, CraftingSkill.Blacksmithing],
  [CraftingResourcesBlueprint.CorruptionIngot, CraftingSkill.Blacksmithing],
  [CraftingResourcesBlueprint.SteelIngot, CraftingSkill.Blacksmithing],
