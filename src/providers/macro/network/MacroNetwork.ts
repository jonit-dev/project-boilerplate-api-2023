...
import { MacroNetworkTrigger } from "./MacroNetworkTrigger";
import { MacroNetworkVerify } from "./MacroNetworkVerify";

@provide(MacroNetwork)
export class MacroNetwork {
  constructor(
    private macroNetworkTrigger: MacroNetworkTrigger,
    private macroNetworkCheck: MacroNetworkCheck,
    private macroNetworkVerify: MacroNetworkVerify
  ) {}

  public onAddEventListeners(channel: SocketChannel): void {
    this.macroNetworkTrigger.onMacroTrigger(channel);
