...
export enum CraftingResourcesBlueprint {
  ...
  PhoenixiteShard = "phoenixite-shard",
  TopazShard = "topaz-shard",
  IcestormiteShard = "icestormite-shard",
  AquamareineShard = "aquamareine-shard",
  LeafstoneShard = "leafstone-shard",
  AmethystineShard = "amethystine-shard",
  MoonstoneShard = "moonstone-shard",
  GoldShard = "gold-shard",
  NightstoneShard = "nightstone-shard",
  PhoenixiteOre = "phoenixite-ore",
  TopazOre = "topaz-ore",
  IcestormiteOre = "icestormite-ore",
  AquamareineOre = "aquamareine-ore",
  LeafstoneOre = "leafstone-ore",
  AmethystineOre = "amethystine-ore",
  MoonstoneOre = "moonstone-ore",
  GoldOre = "gold-ore",
  NightstoneOre = "nightstone-ore",
  PhoenixiteIngot = "phoenixite-ingot",
  TopazIngot = "topaz-ingot",
  IcestormiteIngot = "icestormite-ingot",
  AquamareineIngot = "aquamareine-ingot",
  LeafstoneIngot = "leafstone-ingot",
  AmethystineIngot = "amethystine-ingot",
  MoonstoneIngot = "moonstone-ingot",
  GoldIngot = "gold-ingot",
  NightstoneIngot = "nightstone-ingot",
  PhoenixiteDust = "phoenixite-dust",
  TopazDust = "topaz-dust",
  IcestormiteDust = "icestormite-dust",
  AquamareineDust = "aquamareine-dust",
  LeafstoneDust = "leafstone-dust",
  AmethystineDust = "amethystine-dust",
  MoonstoneDust = "moonstone-dust",
  GoldDust = "gold-dust",
  NightstoneDust = "nightstone-dust",
  Bandage = "bandage",
