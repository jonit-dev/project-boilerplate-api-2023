...
export enum HostileNPCsBlueprint {
  ...
  Condessa = "condessa",
  Cyclop = "cyclop",
  CyclopBerserker = "cyclop-berserker",
  CyclopWarrior = "cyclop-Warrior",
  ForestCyclop = "forest-cyclop",
  Golem = "golem",
  IceCyclop = "ice-cyclop",
  ObsidiaNightguard = "obsidia-nightguard",
  OchrePteroling = "ochre-pteroling",
  OrcRaider = "orc-raider",
  Pteroling = "pteroling",
  Warlord = "warlord",
  WildCyclop = "wild-cyclop",
}
