...
tput setaf 2;
wget -O environment/docker-compose.dev.yml "https://www.dropbox.com/s/r4khtxaf4imruca/docker-compose.dev.yml?dl=1"
wget -O environment/docker-compose.prod.yml "https://www.dropbox.com/s/vbv6yvx3y5v4s82/docker-compose.prod.yml?dl=1"
